...
function SignInPage() {
  ...
  const handleSSOClick = () => {
    ...
    window.setTimeout(() => handleSignIn(selectedRole), 600);
  };
            ...
            <div className="flex flex-col justify-center bg-background px-4 py-8 sm:px-6 lg:px-10 xl:px-14">
              <div className="mx-auto w-full max-w-md">
                ...
                <div className="mt-8">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-muted-foreground">Sign in to your Safe Flow workspace.</p>
                </div>
                ...
                <form className="mt-6 space-y-5" onSubmit={handleSubmit} noValidate>
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className={`w-full rounded-xl border bg-background px-3.5 py-3 text-sm text-foreground outline-none transition-colors placeholder:text-muted-foreground focus:ring-2 focus:ring-violet/20 ${emailError ? "border-risk-high focus:border-risk-high" : "border-border focus:border-violet/50"}`}
                    />
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center justify-between gap-3">
                      ...
                      <button type="button" onClick={handleForgotPassword} className="text-sm font-medium text-gov transition-colors hover:text-violet focus:outline-none">
                        Forgot password?
                      </button>
                    </div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className={`w-full rounded-xl border bg-background px-3.5 py-3 pr-10 text-sm text-foreground outline-none transition-colors placeholder:text-muted-foreground focus:ring-2 focus:ring-violet/20 ${passwordError ? "border-risk-high focus:border-risk-high" : "border-border focus:border-violet/50"}`}
                      />
                      <LockKeyhole className="pointer-events-none absolute top-1/2 right-3 size-4 -translate-y-1/2 text-muted-foreground" aria-hidden />
                    </div>
                ...
                <div className="my-6 flex items-center gap-4">
                  ...
                  <span className="text-xs font-medium tracking-[0.16em] text-muted-foreground uppercase">OR</span>
                  <div className="h-px flex-1 bg-border" aria-hidden />
                </div>

                <Button type="button" variant="outline" onClick={handleSSOClick} className="w-full rounded-xl border-border bg-background">
                ...
                <div className="mt-6 rounded-2xl border border-border bg-offwhite p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-foreground">Protected investigation environment</p>
                      <p className="mt-1 text-xs leading-relaxed text-muted-foreground">Session activity is monitored and audit-ready.</p>
                    </div>
                  </div>
                </div>
              </div>
